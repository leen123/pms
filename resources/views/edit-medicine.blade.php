...
@section('content')
        ...
        <div class="product">
          <h3 class="page-header-title">Add New Product:</h3>
            ...
            <form action="/edit-medicine/{{$product->id}}"  class="product__form" method="POST" enctype="multipart/form-data">

              @csrf

                   <div class="product__form__group">
                    <label for="barcode"  class="product__form__label">Barcode:</label>
                    <input type="text" class="product__form__input" placeholder="Enter barcode" id="barcode" name="barcode"  value="{{$product->barcode}}">
                  </div>

             <div class="product__form__group">
              <label for="name" class="product__form__label">Name:</label>
              <input type="text"  class="product__form__input" placeholder="Name"  id="name" name="name"  value="{{$product->name}}">
            </div>
   ...
   <div class="product__form__group">
    ...
    <input type="number" class="product__form__input" placeholder="Enter limit_Qty" id="limit_Qty" name="limit_Qty"  value="{{$product->limit_Qty}}">
  </div>
...
<!--
        ...
        <div class="product__form__group">
            ...
            <input type="number"class="product__form__input" placeholder="Enter net price ($)" id="net_price" name="net_price"  value="{{$product->net_price}}">
          </div>

            <div class="product__form__group">
    <label for="current_price"  class="product__form__label">Current price:</label>
   <input type="number" class="product__form__input" placeholder="Enter current price ($)" id="current_price" name="current_price"  value="{{$product->current_price}}">
  </div>
    ...
    <select class="product__form__input" name="shelf_id">
      ...
      @endforeach
              ...
              <div class="product__form__group">
                ...
                <textarea  class="product__form__input product__form__input__description" required placeholder="Enter description" name="description"  value="{{$product->description}}"></textarea>
              </div>

              <div class="product__form__group">
                <label for="image"  class="product__form__label">Image:</label>
                <input type="file" class="product__form__input" placeholder="Enter image" id="image" name="image" value="{{$product->image}}">
              </div>


     <div class="product__form__group">
    <label for="application"  class="product__form__label">Application:</label>
    <textarea  class="product__form__input product__form__input__description" required placeholder="Enter application" name="application"  value="{{$product->application}}"></textarea>
  </div>

  <div class="product__form__group">
    <label for="composition"  class="product__form__label">Composition:</label>
    <textarea   class="product__form__input product__form__input__description" required placeholder="Enter composition" name="composition"  value="{{$product->composition}}"></textarea>
  </div>

  <div class="product__form__group">
    <label for="side_effects" class="product__form__label">Side_effects:</label>
    <textarea c class="product__form__input product__form__input__description" required placeholder="Enter side_effects" name="side_effects"  value="{{$product->side_effects}}"></textarea>
  </div>

  <div class="product__form__group">
    <label for="notes"  class="product__form__label">Notes:</label>
    <textarea  class="product__form__input product__form__input__description" required placeholder="Enter notes" name="notes"  value="{{$product->notes}}"></textarea>
  </div>

            <div class="product__form__group">
              <!--<input type="button" class="product__form__input product__form__input__button" value="Add"> -->
              <button type="submit" class="product__form__input product__form__input__button">Edit</button>
              <a href="{{route('search-for-medicine')}}" class="product__form__input product__form__input__button product__form__input__button--red">Cancel</a>
