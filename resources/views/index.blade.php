...
<head>
    ...
    <!--Already included in our css file-->
    ...
    <div class="login">
        ...
        <form action="#" class="login__form">
            ...
            <div class="login__form__group">
                <input type="text" placeholder="{{__('pages.username')}}" class="login__form__input" required>
                <label class="login__form__label">Username</label>
            </div>

            <div class="login__form__group">
                <input type="password" placeholder="{{__('pages.password')}}" class="login__form__input" required>
                <label class="login__form__label">Password</label>
            </div>

            <a href="{{route('launcher')}}" class="btn btn__launcher btn__launcher--empty login--btn">{{__('pages.login')}}</a>
        </form>
    </div>
